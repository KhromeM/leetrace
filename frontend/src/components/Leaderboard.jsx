...
export const Leaderboard = () => {
	...
	return (
		<div className="max-w-2xl mx-auto p-6">
			<h2 className="text-2xl font-bold mb-6 text-[#cccccc]">Top Players</h2>

			<div className="bg-[#282828] shadow-lg rounded-lg overflow-hidden border border-[#3e3e3e]">
				<div className="grid grid-cols-4 bg-[#1e1e1e] p-4 font-semibold border-b border-[#3e3e3e]">
				...
				{topPlayers.map((player) => (
					<div
						key={player.id}
						className={`grid grid-cols-4 p-4 border-b border-[#3e3e3e] hover:bg-[#2d2d2d] ${
					...
					>
						...
						<div className="col-span-2 flex items-center text-[#cccccc]">
							<img
								src={player.photoURL}
								alt=""
			...
			<div className="mt-8 grid grid-cols-2 gap-4">
				<div className="bg-[#282828] p-4 rounded-lg shadow border border-[#3e3e3e]">
					<h3 className="text-sm font-semibold text-[#8a8a8a] mb-1">
						Total Players
					</h3>
